class TrucksController < ApplicationController
  ...
  private
    ...
    def truck_params
      ...
      params.require(:truck).permit(:address, :address_formatted_address, :address_street_number, :address_street_name, :address_street, :address_city, :address_zip_code, :address_department, :address_department_code, :address_state, :address_state_code, :address_country, :address_country_code, :address_lat, :address_lng, :address_destroy
      )
    end
end
