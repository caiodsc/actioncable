...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { address: @truck.address, serial_number: @truck.serial_number } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { address: @truck.address, serial_number: @truck.serial_number } }
